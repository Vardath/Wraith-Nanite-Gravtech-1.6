...
CORE_TEXTURE_PLACEHOLDERS = {
    ...
    "Things/Building/Power/WoodFiredGenerator",  # WNG_BioelectricOrgan temporary visual only
    "Things/Building/Furniture/Bed/Bed",  # WNG_FeedingNiche temporary visual only
}
