...
for needle, description in [
    ...
    ("WraithCaptiveTreatmentStage.FeedingStock", "Captivity must begin as feeding stock"),
    ("WraithCaptiveTreatmentStage.Experimentation", "Experimentation treatment stage is missing"),
    ("WraithCaptiveTreatmentStage.Conditioning", "Conditioning treatment stage is missing"),
    ("WraithCaptiveTreatmentStage.Enthralled", "Enthrallment treatment stage is missing"),
