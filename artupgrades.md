...
9. **Full 217-apparel re-audit** — **STRUCTURAL/TEMPLATE AUDIT COMPLETE; professional visual review still required.** The current `WNG Apparel Art Audit` fully decodes all 217 apparel PNGs and applies separate rules for inventory/base sprites versus worn overlays. Latest audited state at `93f9d7a1c573f3fb40d1f0223a1bab6bf94d6176`: `WNG_APPAREL_COUNT 217`, `WNG_APPAREL_FLAGGED 0`; no edge-alpha failures and no horizontal/template-position violations under the current worn-overlay rules. This does **not** by itself approve the visual design at pawn scale; each apparel family still needs professional appearance review.
